...
![全局色](illustrator-trips.assets/illustrator-trip13.jpg)
...
![轻松应用颜色](illustrator-trips.assets/illustrator-trip23.jpg)

## 清洁路径

最近，我一直在用我的素描风格的画笔插图和教程。在一些这些插图，笔触需要将扩大到可编辑的路径。扩大时，你也可以得到一堆填补路径。要清理，只需转到对象>路径>清理和检查未上色的对象“复选框。您也可以使用此功能，摆脱空文本框和杂散点！

![清洁路径](illustrator-trips.assets/illustrator-trip62.jpg)

## 制作网格

制作单页印刷品或小册子时，使用「分割为网格」工具，可以极快地给页面打上网格。

![制作网格](illustrator-trips.assets/illustrator-trip33.jpg)

## 变换窗口中可以输入百分比

![百分比](illustrator-trips.assets/illustrator-trip40.jpg)

## 快速制作页脚

在做画册的时候，有时候会在画板里做页眉和页脚，要是每一页的去复制粘贴，再对位置（每一页的位置一样）是件小小的麻烦工作。把页眉和页脚成组，复制。在编辑菜单中选择“在所有画板上粘贴”或按快捷键`alt+shift+ctrl+v`

![快速制作页脚](illustrator-trips.assets/illustrator-trip63.png)

## 用形状生成工具画爱心

![用形状生成工具画爱心](illustrator-trips.assets/illustrator-trip68.jpg)

## `~`键的重复效果

无限重复的效果就是`~`键做出来的！选择矩形工具/直线段工具，然后按住`~`键不放。

![重复效果](illustrator-trips.assets/illustrator-trip19.jpg)
...
![复合路径](illustrator-trips.assets/illustrator-trip20.jpg)
...
![快速绘制图形内部](illustrator-trips.assets/illustrator-trip67.jpg)

## 快速调整星形形状

在绘制星形形状时，总以为角大小在创建时是固定的，所以绘制星形形状经常绘制完再去调整那些星星的角。但是我们只需要在绘制的时候，按住`Ctrl`键(win)或`command`(mac)即可拖动鼠标来调整星星的角的大小。

![快速调整星形形状](illustrator-trips.assets/illustrator-trip35.jpg)
...
![粉笔字效果](illustrator-trips.assets/illustrator-trip31.png)
...
![快速切割对象1](illustrator-trips.assets/illustrator-trip51.png)

切割效果如下：
![快速切割对象1](illustrator-trips.assets/illustrator-trip57.jpg)
...
![专色1](illustrator-trips.assets/illustrator-trip30.jpg)

**第二步** 建立色板后，切换到"颜色参考"面板，点击面板下方图标，出现下拉菜单，然后点击"色标簿"\PANTONE+ Solid Coated（这里可选择自己需要查找的色卡类型）

![专色2](illustrator-trips.assets/illustrator-trip59.png)

**第三步** 色卡类型选好后，单击"颜色参考"面板推荐的颜色，然后切换到"颜色"面板，最接近目标的专色号就呈现在你的面前。

![专色3](illustrator-trips.assets/illustrator-trip2.jpg)

## 精确分布对象

AI更偏于创作，而不像Autodesk的软件那样有极高的精确度，但AI也可以通过具体数值来控制对象属性，其中最实用也常被忽略的莫过于"分布间距"这个功能了。

![精确分布对象01](illustrator-trips.assets/illustrator-trip45.png)

上面两行分别是"对齐对象"和"分布对象"，大家肯定不陌生，而下面的"分布间距"是根据具体参数来分布多个对象的，例子在下面。

![精确分布对象02](illustrator-trips.assets/illustrator-trip27.png)

## 使用吸管工具复制样式

关于吸管工具的用法，这里只介绍它与快捷键组合后的功能。 与`Shift`键组合：仅提取目标颜色并应用到当前属性，以下图为例，红色矩形提取黑色来填充而不影响描边。

![吸管工具01](illustrator-trips.assets/illustrator-trip7.png)

与`Alt`键组合：提取并应用当前软件设置的属性（很重要，提高效率的必备良药）

![吸管工具02](illustrator-trips.assets/illustrator-trip41.png)

按住`Alt键`后，吸管图标会变成这样

![吸管工具03](illustrator-trips.assets/illustrator-trip14.png)

与`Alt`键组合可以提取并应用的对象属性很多，比如填充/描边的颜色，文字的字体字号等

![吸管工具01](illustrator-trips.assets/illustrator-trip39.png)

快捷键`”i”`，吸管工具除了取色，还可以填色，选择吸管工具后，`Alt+鼠标左键`点由即可给其他形状填色。

## 画板的模版功能

![画板的模版功能](illustrator-trips.assets/illustrator-trip44.jpg)

此功能比较简单，仅以下几点稍加留意即可：
画板的堆叠顺序 先命名画板再导出文件更易管理 多画板文件的模版应用 多画板另存时单独选择，如下图

![画板的模版功能](illustrator-trips.assets/illustrator-trip9.jpg)
...
![多重描边](illustrator-trips.assets/illustrator-trip16.png)
...
![多重描边](illustrator-trips.assets/illustrator-trip8.png)

接下来，在AI中你还可以再新建一个描边，颜色设置为纯白，依然是内侧对齐，透明度为 50%。并在外观面板里，把这个描边置于灰色描边的下方，如图：

![多重描边](illustrator-trips.assets/illustrator-trip28.png)

按钮看上去没有什么变化。不过接下来，就是见证奇迹的时刻了。给半透明白色描边加上一个「变换」效果，「移动」参数设置为 1 像素：

![多重描边](illustrator-trips.assets/illustrator-trip38.png)

最后用多重填充多描边做的按钮

![多重描边](illustrator-trips.assets/illustrator-trip34.png)

然后你可以给按钮改变颜色，只需要对第一次填充的颜色进行修改就可以啦

![多重描边](illustrator-trips.assets/illustrator-trip61.png)

## 导出选中的对象

如何导出选定对象？选中对象，"对象">"画板">"适合选中的图稿"，导出时勾选“使用画板”。

![导出选中的对象](illustrator-trips.assets/illustrator-trip29.png)

## 不同颜色模式切换

`Shift+单击颜色条`，可在几种颜色模式依次切换。

![不同颜色模式切换](illustrator-trips.assets/illustrator-trip10.png)

## 选中重叠的对象

选择工具，按住`ctrl`鼠标左键连续点击，即可上下对象切换选择（ps：其它工具也可以）

![选中重叠的对象](illustrator-trips.assets/illustrator-trip65.gif)

## 移动设置面板

工具箱中双击移动工具图标，调出移动设置面板；
"对象">"变换">"移动"；
按下快捷键：`ctrl+shift+M`以上三个方法都可以调出下面的“移动”对话框
...
![选中重叠的对象](illustrator-trips.assets/illustrator-trip6.gif)
...
![放射光线效果01](illustrator-trips.assets/illustrator-trip64.png)

![放射光线效果02](illustrator-trips.assets/illustrator-trip37.png)

![放射光线效果03](illustrator-trips.assets/illustrator-trip25.png)

![放射光线效果04](illustrator-trips.assets/illustrator-trip11.png)
...
也可以“选择”>“对象”>“文本对象”，即可选择所有文字。再转曲

## 快捷键

![illustrator快捷键](illustrator-trips.assets/illustrator-trip53.png)

## 快速编辑形状

**方向键箭头键**将增加星形工具和多边形工具上的点。这些键还将在“螺旋工具”上添加线段，并将列和行添加到“矩形网格工具”和“极坐标网格工具”中。

![快速编辑形状1](illustrator-trips.assets/illustrator-trip22.jpg)

空格键拖动时按住空格键将重新定位形状。

![快速编辑形状2](illustrator-trips.assets/illustrator-trip60.jpg)

`⌘`/ `Ctrl`拖动时按住`⌘`/ `Ctrl`键将固定星形工具的内半径，并在螺旋工具中添加或减去衰减。

![快速编辑形状3](illustrator-trips.assets/illustrator-trip56.jpg)

Tilde（`〜`）拖动时按住Tilde（`〜`）将根据拖动的长度和速度重复形状。

![快速编辑形状4](illustrator-trips.assets/illustrator-trip70.jpg)

## 快速选择补色

![快速选择补色](illustrator-trips.assets/illustrator-trip36.jpg)
...
![反向笔刷笔划](illustrator-trips.assets/illustrator-trip66.jpg)
...
![从网格形状中提取路径](illustrator-trips.assets/illustrator-trip69.jpg)
...
![从网格形状中提取路径](illustrator-trips.assets/illustrator-trip52.jpg)
...
！
![在打开的选项卡文档之间快速切换](illustrator-trips.assets/illustrator-trip43.jpg)
...
![快速预览图形样式](illustrator-trips.assets/illustrator-trip26.jpg)
...
![默认角半径](illustrator-trips.assets/illustrator-trip42.jpg)
...
![默认角半径](illustrator-trips.assets/illustrator-trip58.jpg)
...
![约束角度](illustrator-trips.assets/illustrator-trip12.jpg)
...
![路径查找器](illustrator-trips.assets/illustrator-trip1.jpg)
...
![快速创建画板](illustrator-trips.assets/illustrator-trip3.jpg)
...
![网格布局](illustrator-trips.assets/illustrator-trip49.jpg)

**成分指南**
我使用SIG功能的另一种方法是用于组合指南。通过一些插图，我使用一个简单的组合网格。它通常是一个基本的3×3网格，没有像我用于布局的网格那样具体。只是一个网格，我可以编辑主要的组成元素。我通常将这些网格转换为与网格布局类似的指南。

![网格布局](illustrator-trips.assets/illustrator-trip4.jpg)

你呢？我相信你们中的一些人对Split Into Grid功能有一些很好的用例。请分享！

## 叠印与套印和陷印区别

![叠印与套印和陷印区别](illustrator-trips.assets/illustrator-trip54.png)

## 色彩原理

![叠印与套印和陷印区别](illustrator-trips.assets/illustrator-trip71.png)
...
![减法三原料的混合--CMYK](illustrator-trips.assets/illustrator-trip5.png)
...
![640](illustrator-trips.assets/640.jpg)

![641](illustrator-trips.assets/641.jpg)

![642](illustrator-trips.assets/642.jpg)

![643](illustrator-trips.assets/643.jpg)

![644](illustrator-trips.assets/644.jpg)

![645](illustrator-trips.assets/645.jpg)

![646](illustrator-trips.assets/646.jpg)

![647](illustrator-trips.assets/647.jpg)

![648](illustrator-trips.assets/648.jpg)

## 形状生成器工具

![形状生成器工具](illustrator-trips.assets/ai-trip2.png)

## 添加描点

![添加描点](illustrator-trips.assets/ai-trip6.png)

## 刻刀

![刻刀](illustrator-trips.assets/ai-trip1.png)

## 画笔工具选项

![画笔工具选项](illustrator-trips.assets/ai-trip15.png)
...
![让AI实现文字打散1](illustrator-trips.assets/ai-trip13.jpg)

２、Ctrl+T，打开文字控制面板，将所想要打散的字旋转0.01度（此为关键）

![让AI实现文字打散2](illustrator-trips.assets/ai-trip11.jpg)

３、打开“对象”——拼合透明度“，对话框，拼合

![让AI实现文字打散3](illustrator-trips.assets/ai-trip12.jpg)

４、第一次解组，分成一行行了

![让AI实现文字打散4](illustrator-trips.assets/ai-trip10.jpg)

５、再次解组，就变成一个个了

![让AI实现文字打散5](illustrator-trips.assets/ai-trip14.jpg)

## 方头端点

![方头端点](illustrator-trips.assets/ai-trip5.png)

## 直排内横排

![直排内横排](illustrator-trips.assets/ai-trip9.png)

## 画黄金分割线

![画黄金分割线01](illustrator-trips.assets/ai-trip7.png)

![画黄金分割线02](illustrator-trips.assets/ai-trip8.png)

## 怎么把一个图片转换成黑白矢量图

![怎么把一个图片转换成黑白矢量图](illustrator-trips.assets/ai-trip3.png)
...
![AI合并图层](illustrator-trips.assets/adobe-illustrator-001.jpg)

## ai图形透视

按E，鼠标点住不放手，注意哦，是要先点住不放手。再按：CTRL+ALT+SHIFT

![AI合并图层](illustrator-trips.assets/adobe-illustrator-002.jpg)

## ai反相圆角

![ai反相圆角](illustrator-trips.assets/adobe-illustrator-003.jpg)

## ai不透明度蒙版

![ai不透明度蒙版](illustrator-trips.assets/adobe-illustrator-004.jpg)

## AI渐变调色，选择滑杆一端，再在左侧填色区直接粘贴即可

![AI渐变调色](illustrator-trips.assets/adobe-illustrator-005.jpg)

## ai批量修改颜色

编辑--编辑颜色--重置颜色图稿。全选需要一次更换颜色的对象，

![ai批量修改颜色](illustrator-trips.assets/adobe-illustrator-006.jpg)
...
![AI快速合并图形方法](illustrator-trips.assets/adobe-illustrator-007.jpg)
...
![AI快速合并图形方法](illustrator-trips.assets/adobe-illustrator-008.jpg)

快速嵌入方法2  
文件另存为——在选项面板中打钩“包含链接文件”和“嵌入ICC配置文件”这样保存处理的文件也会嵌入文件。

![AI快速合并图形方法](illustrator-trips.assets/adobe-illustrator-009.jpg)
...
![AI快速合并图形方法](illustrator-trips.assets/adobe-illustrator-010.jpg)

上面两行分别是"对齐对象"和"分布对象"，大家肯定不陌生，而下面的"分布间距"是根据具体参数来分布多个对象的，例子在下面。

![AI快速合并图形方法](illustrator-trips.assets/adobe-illustrator-011.jpg)

## 建立图案

1. AI图案 - 对象 - 图案 - 建立
    ![图案](illustrator-trips.assets/adobe-illustrator-012.jpg)
2. 打开色板面板，直接将图案拖入也可。
    ![图案](illustrator-trips.assets/adobe-illustrator-016.jpg)
    ![图案](illustrator-trips.assets/adobe-illustrator-017.jpg)

## 缩放描边和效果

ctrl+k调出首选项——常规——勾选——缩放描边和效果
![缩放描边和效果](illustrator-trips.assets/adobe-illustrator-018.jpg)
...
左边是上下零间距，右边是左右零间距
![物体紧挨着物体](illustrator-trips.assets/adobe-illustrator-019.jpg)

## 快速替换ai中缺失文本字体

![快速替换ai中缺失文本字体](illustrator-trips.assets/adobe-illustrator-020.jpg)

## ai剪切组转换成路径图形方法

![ai剪切组转换成路径图形方法](illustrator-trips.assets/adobe-illustrator-021.jpg)

![ai剪切组转换成路径图形方法](illustrator-trips.assets/adobe-illustrator-022.jpg)
...
![蒙板](illustrator-trips.assets/adobe-illustrator-023.jpg)

c 图层蒙板【将需要的图形置于最上层，点击图层面板中“建立/释放图层蒙板”

![蒙板](illustrator-trips.assets/adobe-illustrator-024.jpg)
...
点击“扩展”生展分层路径。
![蒙板](illustrator-trips.assets/adobe-illustrator-025.jpg)

## 怎么样图片渐变色应用于矢量对象上？

## 吸取图片色，新建色板，单击确定

![吸取图片色1](illustrator-trips.assets/adobe-illustrator-026.jpg)

将保存的色块拖动至渐变的色块上。

![吸取图片色2](illustrator-trips.assets/adobe-illustrator-027.jpg)
...
![路径查找器](illustrator-trips.assets/illustrator-a.jpg)

## 用AI辅助配色

色彩搭配一直是设计中非常重要但又很难掌握的一门学问。关于颜色的选择与搭配，其实AI有提供一款参考工具，该工具可以在窗口菜单栏中的下方找到，快捷键为Shift+F3。

![路径查找器](illustrator-trips.assets/illustrator-b.jpg)
...
![路径查找器](illustrator-trips.assets/illustrator-c.jpg)

当然，这只不过是配色的一种方法而已，设计主题、品牌调性才是配色最需要考虑的因素，所以不要照搬配色工具。

## 巧用橡皮擦工具

![巧用橡皮擦工具](illustrator-trips.assets/illustrator-a01.jpg)

## 利用拼合透明度裁切位图

![利用拼合透明度裁切位图](illustrator-trips.assets/illustrator-a02.jpg)

![利用拼合透明度裁切位图](illustrator-trips.assets/illustrator-a03.jpg)

## 互补色、对比色、邻近色、同类色

![互补色、对比色、邻近色、同类色](illustrator-trips.assets/色彩.jpg)
