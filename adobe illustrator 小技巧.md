...
![全局色](assets/illustrator-trip13.jpg)
...
![复合路径](assets/illustrator-trip20.jpg)
...
![粉笔字效果](assets/illustrator-trip31.png)
...
![快速切割对象1](assets/illustrator-trip51.png)

切割效果如下：
![快速切割对象1](assets/illustrator-trip57.jpg)
...
![多重描边](assets/illustrator-trip16.png)
...
![多重描边](assets/illustrator-trip8.png)

接下来，在AI中你还可以再新建一个描边，颜色设置为纯白，依然是内侧对齐，透明度为 50%。并在外观面板里，把这个描边置于灰色描边的下方，如图：

![多重描边](assets/illustrator-trip28.png)

按钮看上去没有什么变化。不过接下来，就是见证奇迹的时刻了。给半透明白色描边加上一个「变换」效果，「移动」参数设置为 1 像素：

![多重描边](assets/illustrator-trip38.png)

最后用多重填充多描边做的按钮

![多重描边](assets/illustrator-trip34.png)

然后你可以给按钮改变颜色，只需要对第一次填充的颜色进行修改就可以啦

![多重描边](assets/illustrator-trip61.png)

## 导出选中的对象

如何导出选定对象？选中对象，"对象">"画板">"适合选中的图稿"，导出时勾选“使用画板”。

![导出选中的对象](assets/illustrator-trip29.png)

## 不同颜色模式切换

`Shift+单击颜色条`，可在几种颜色模式依次切换。

![不同颜色模式切换](assets/illustrator-trip10.png)

## 选中重叠的对象

选择工具，按住`ctrl`鼠标左键连续点击，即可上下对象切换选择（ps：其它工具也可以）

![选中重叠的对象](assets/illustrator-trip65.gif)
...
![选中重叠的对象](assets/illustrator-trip6.gif)
...
![放射光线效果01](assets/illustrator-trip64.png)

![放射光线效果02](assets/illustrator-trip37.png)

![放射光线效果03](assets/illustrator-trip25.png)

![放射光线效果04](assets/illustrator-trip11.png)
...
![illustrator快捷键](assets/illustrator-trip53.png)

## 快速编辑形状

**方向键箭头键**将增加星形工具和多边形工具上的点。这些键还将在“螺旋工具”上添加线段，并将列和行添加到“矩形网格工具”和“极坐标网格工具”中。

![快速编辑形状1](assets/illustrator-trip22.jpg)

空格键拖动时按住空格键将重新定位形状。

![快速编辑形状2](assets/illustrator-trip60.jpg)

`⌘`/ `Ctrl`拖动时按住`⌘`/ `Ctrl`键将固定星形工具的内半径，并在螺旋工具中添加或减去衰减。

![快速编辑形状3](assets/illustrator-trip56.jpg)

Tilde（`〜`）拖动时按住Tilde（`〜`）将根据拖动的长度和速度重复形状。

![快速编辑形状4](assets/illustrator-trip70.jpg)

## 快速选择补色

![快速选择补色](assets/illustrator-trip36.jpg)
...
![反向笔刷笔划](assets/illustrator-trip66.jpg)
...
![从网格形状中提取路径](assets/illustrator-trip69.jpg)
...
![从网格形状中提取路径](assets/illustrator-trip52.jpg)
...
！
![在打开的选项卡文档之间快速切换](assets/illustrator-trip43.jpg)
...
![快速预览图形样式](assets/illustrator-trip26.jpg)
...
![默认角半径](assets/illustrator-trip42.jpg)
...
![默认角半径](assets/illustrator-trip58.jpg)
...
![约束角度](assets/illustrator-trip12.jpg)
...
![路径查找器](assets/illustrator-trip1.jpg)
...
![快速创建画板](assets/illustrator-trip3.jpg)
...
![减法三原料的混合--CMYK](assets/illustrator-trip5.png)
...
![形状生成器工具](assets/ai-trip2.png)

## 添加描点

![添加描点](assets/ai-trip6.png)

## 刻刀

![刻刀](assets/ai-trip1.png)

## 画笔工具选项

![画笔工具选项](assets/ai-trip15.png)
...
![让AI实现文字打散1](assets/ai-trip13.jpg)

２、Ctrl+T，打开文字控制面板，将所想要打散的字旋转0.01度（此为关键）

![让AI实现文字打散2](assets/ai-trip11.jpg)

３、打开“对象”——拼合透明度“，对话框，拼合

![让AI实现文字打散3](assets/ai-trip12.jpg)

４、第一次解组，分成一行行了

![让AI实现文字打散4](assets/ai-trip10.jpg)

５、再次解组，就变成一个个了

![让AI实现文字打散5](assets/ai-trip14.jpg)

## 方头端点

![方头端点](assets/ai-trip5.png)

## 直排内横排

![直排内横排](assets/ai-trip9.png)

## 画黄金分割线

![画黄金分割线01](assets/ai-trip7.png)

![画黄金分割线02](assets/ai-trip8.png)

## 怎么把一个图片转换成黑白矢量图

![怎么把一个图片转换成黑白矢量图](assets/ai-trip3.png)
...
![AI合并图层](assets/adobe-illustrator-001.jpg)

## ai图形透视

按E，鼠标点住不放手，注意哦，是要先点住不放手。再按：CTRL+ALT+SHIFT

![AI合并图层](assets/adobe-illustrator-002.jpg)

## ai反相圆角

![ai反相圆角](assets/adobe-illustrator-003.jpg)

## ai不透明度蒙版

![ai不透明度蒙版](assets/adobe-illustrator-004.jpg)

## AI渐变调色，选择滑杆一端，再在左侧填色区直接粘贴即可

![AI渐变调色](assets/adobe-illustrator-005.jpg)

## ai批量修改颜色

编辑--编辑颜色--重置颜色图稿。全选需要一次更换颜色的对象，

![ai批量修改颜色](assets/adobe-illustrator-006.jpg)
...
![AI快速合并图形方法](assets/adobe-illustrator-007.jpg)
...
![AI快速合并图形方法](assets/adobe-illustrator-008.jpg)

快速嵌入方法2  
文件另存为——在选项面板中打钩“包含链接文件”和“嵌入ICC配置文件”这样保存处理的文件也会嵌入文件。

![AI快速合并图形方法](assets/adobe-illustrator-009.jpg)
...
![AI快速合并图形方法](assets/adobe-illustrator-010.jpg)

上面两行分别是"对齐对象"和"分布对象"，大家肯定不陌生，而下面的"分布间距"是根据具体参数来分布多个对象的，例子在下面。

![AI快速合并图形方法](assets/adobe-illustrator-011.jpg)

## 建立图案

1. AI图案 - 对象 - 图案 - 建立
    ![图案](assets/adobe-illustrator-012.jpg)
2. 打开色板面板，直接将图案拖入也可。
    ![图案](assets/adobe-illustrator-016.jpg)
    ![图案](assets/adobe-illustrator-017.jpg)

## 缩放描边和效果

ctrl+k调出首选项——常规——勾选——缩放描边和效果
![缩放描边和效果](assets/adobe-illustrator-018.jpg)
...
左边是上下零间距，右边是左右零间距
![物体紧挨着物体](assets/adobe-illustrator-019.jpg)

## 快速替换ai中缺失文本字体

![快速替换ai中缺失文本字体](assets/adobe-illustrator-020.jpg)

## ai剪切组转换成路径图形方法

![ai剪切组转换成路径图形方法](assets/adobe-illustrator-021.jpg)

![ai剪切组转换成路径图形方法](assets/adobe-illustrator-022.jpg)
...
![蒙板](assets/adobe-illustrator-023.jpg)

c 图层蒙板【将需要的图形置于最上层，点击图层面板中“建立/释放图层蒙板”

![蒙板](assets/adobe-illustrator-024.jpg)
...
点击“扩展”生展分层路径。
![蒙板](assets/adobe-illustrator-025.jpg)

## 怎么样图片渐变色应用于矢量对象上？

## 吸取图片色，新建色板，单击确定

![吸取图片色1](assets/adobe-illustrator-026.jpg)

将保存的色块拖动至渐变的色块上。

![吸取图片色2](assets/adobe-illustrator-027.jpg)
...
![路径查找器](assets/illustrator-c.jpg)

当然，这只不过是配色的一种方法而已，设计主题、品牌调性才是配色最需要考虑的因素，所以不要照搬配色工具。

## 巧用橡皮擦工具

![巧用橡皮擦工具](assets/illustrator-a01.jpg)
