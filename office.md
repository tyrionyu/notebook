...
3. 数据摆放不连续；上下左右数据全挨着；
    ...
    >删除多列->定位空值，删整列
    >转置——>选择性粘粘，转置
    >![image-20230605214847264](office.assets/image-20230605214847264.png)
4. 合计行破坏源表
    >合计行莫用手填，Excel帮你变
5. 多表头引发问题
    >同属性字段记一列
    >
    >![image-20230605222808309](office.assets/image-20230605222808309.png)
    >
    >![image-20230605222950780](office.assets/image-20230605222950780.png)
6. 合并单元格后患无穷
    > 原数据表“打死”不合并
    > 1、`F5`定位；2、批量录入（ctrl+enter）
    >
    > ![image-20230606073745319](office.assets/image-20230606073745319.png)
7. 源数据缺胳膊少腿
    > 字段设计-分析、拓展、补全
    > 流程解析——工作顺序、录入方式
8. 分数据容易牵手难
