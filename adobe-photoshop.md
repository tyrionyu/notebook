...
## DeepSeek与adobe Potoshop抠图脚本

我是一名设计师，现在老板要我出一个抠图的脚本，我的PS是2022版的。请帮我出一个2022版兼容的脚本。
...
想要颜色变亮一点要用加色模式，想变暗就用减色模式去绘制。

![色环](adobe-photoshop.assets/image-20230624213919196.png)

## 磨砂质感背景

1. 先填充一个背景色。
2. 新建一层，滤镜-杂色-添加杂色，选择单色，混合选择柔光。
3. ctrl+J 复制一层，ctrl+i 反向，右移一次，下移一次。调整透明度。
4. 新建一层，渐变白色到透明，降低透明度。
