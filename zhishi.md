...
> 想象一下，我们上学的时候，从来不需要考虑学什么？怎么做笔记？记在哪里？
>
...
![flomo](zhishi.assets/flomo-b.png)
...
> 比如下面这本书的目录，看完之后请给自己一个答案，你会去买这本书吗？
>
...
笔记的名称没有固定的规则，取决于你的需求，需求越复杂，规则自然也就越多。
...
>>>>>>> 凡是需要大家记忆的，我都会用序列的格式。
>>>>>>>
>>>>>>> ![编号](zhishi.assets/7d649249d962a2d78733be7c56ea6abb.png)
>>>>>>>
>>>>>>> 2- 喜欢小标题。
>>>>>>>
...
用表格管理文件，所有的文件都在一个清单里，使用Excel的查找功能，就可以跨文件夹批量查找，效率大幅提升。
...
或者添加laxiaodeng2017，备注小报童，加入读者群一起交流。
...
![笔记](zhishi.assets/ip.jpeg)

## 人生建议不要等

行动与完美无关；》》》行动是先走一步，再走一步。
...
2. 能学到东西。
3. 能交到朋友。
如果某份工作，三点兼具，就是一个完美的工作。

## ai字体

秀丽笔刷书写字体，主题“xx”​，字体笔画硬朗，有力量，大开大合富有张力，笔画末端带有飞白，返捺，艺术字，黑色底

手写艺术字“xxx”，字体动感,大开大合富有张力,书写末端有飞白，艺术字，笔触流畅，黑底。
...
周长相等的情况下，越接近正方形，面积越大

你买下一个东西，只能叫做交易，当你每天在用这个东西的时候，才叫做消费。
...
人生就像扫雷游戏，成功的父母告诉你哪里没有雷，失败的父母告诉你哪里有雷

世界很大，我们很小，为了梦想，拼搏在外，无畏天涯，才会处处为家。梦想，不分大小；用心守护，才能实现！

一个靠谱的人需要有正确的判断力、超强的执行力、很好的感召力和沟通能力，然后要有极强的驱动力去赶着大家往前走。“而且你要有极大的情商，当你不停抽鞭子的时候，这一鞭子大家还觉得都浑身爽，就是这种感觉非常重要。”
...
输了没关系，只要开始追赶，我们就在赢得路上。先要定个高目标，高目标牵引，要志存高远，怕什么呢？我们已经输不掉了。我们要以无比的乐观精神，来看待工作中生活中，遇到的各种困难。
...
## 干的烂总比不干要好，先完成再完美。
先去做，做出一堆狗屎再慢慢改。这是我今天听到非常震撼、非常有哲理的一段话，分享给你听。

一个粗糙的开始就是最好的开始。想干一件事可以先非常粗糙的去干，丢掉一切得失心的去干，不要等自己准备完美了再去干。先去混混上一段时间，你会发现这个技能就突飞猛进了，突然变得厉害。只要开始，后面越来越上手起来，越有正面反馈，然后就有起色。无从下手的时候就随便弄一下，假装自己游刃有余就好了。

这个其实就是由低到高，由慢到快，量变决定质变的过程。干得烂总比不干要好，先完成再完美。
...
2. 列任务清单； 
3. 打勾法，每完成一项任务，打钩；
4. 打造学习环境，去除无关东西，做好学习前准备（喝水、上厕所等）；
5. 学会鼓励，让好的行为可以复制，夸孩子要夸细节，夸过程；

## 压力

当我遇到压力，经常的做法是，问自己三个问题：

1 你到底在担心什么？

2 假设最坏的情况发生，又会如何？

3 有哪些事情是你现在可以做，从而避免最坏情况发生？

回答完这三个问题，我基本上可以帮助自己解决问题，自己给自己当导师。

第二个问题是：不知道该如何迈出第一步。

从我的感觉来看，你不适合创业。你善于说而不善于做，你不够果断，你缺乏自信和韧性。当然，这些品质都是可以在创业过程中得到锻炼的。为什么你走不出第一步？你试着回答那三个问题：
...
最坏的情况是创业失败了，而且还很辛苦。如果发生了......

3. 有哪些事情现在可以做？

找资金、找合作伙伴、做更充分的准备、一个月后提离职申请……

只要你开始理性的分析这些问题，你会发现你的担心会消失。 有些步骤就可以开始做了。
...
1、花大量的时间做最容易的一个环节
2、有拖延症，没执行力
3、不验证工作结果，只闷头拉车，不抬头看路
4、看了大量的资料，书籍，不总结规律，拿规律去实践中验证并做复盘，总结