...
选中对象，在透视模式下，框选对象。按shift+D，后按ESC会在上面。按P（分享）弹出菜单选择选中项
...
选中两点，游标可以对齐到两点中心；三点可以到三点中心；也可以到面。活动元素是白色（选中一个点，要选其它活动元素，按shift+点击，再点一下）
...
在编辑模式下，按alt+d 键增加加。（顶点->断离顶点并延长）alt+d，后按G，可在那条线上移动
边线滑移；GG。shift+V 也可以，但是有区别

在鼠标中键时，按alt键会吸附到前后左右视图；
...
E，回车一下，再把轴心定位到游标，按S，shift+z，往里缩放。
