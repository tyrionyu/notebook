...
3、可调整混合参数
## 原位复制粘贴
选中一个对象，然后ctrl+c，接着按shift+ctrl+v，这个时候在原来的对象的基础上就多了一个一模一样的对象，并且它们的位置是一模一样的。
## 辅助线与矢量对象的转换
注意，这里的前提是矢量对象，不是位图。将矢量对象选中然后ctrl+5就可以转化为辅助线了，如果要转换回去，按ctrl+alt+5就可以回到原先的矢量图状态。为什么说这个工具很有用呢？如果大家做印前制作就体会到了，特别是包装类的印前制作，我们通过这样的一个操作可以将拼版文件上的刀模线转化为辅助线（因为刀模线最终不能印刷在印刷品上面），从而即不影响最后的印刷输出，但是也不影响到我们在电脑上可以直观的看到刀线卡位在印刷品设计稿上面的样子。
## 画板操作小技巧
如果我们要在ai软件当中将设计稿刚好放在一个画板当中、并且画板和这个设计稿的尺寸是一模一样的，我们可以这样操作：将图文对象群组（Ctrl+G），然后选中，这时候点击工具栏上的画板工具，接着再点击一下这个群组的设计稿，那么就可以做到了。
## 快速查询未转曲文字
查找字体,对于印前交付文件，不必逐个选择检查是文字否转曲。菜单—>文字—>查找字体，如果列表出现字体名称则表示未全部转曲，反之则可以放心交付了。
## 搞定造型段落——>文本绕排
对于造型段落，不必手搓回车或者画区域文字轮廓。选中你段落文本，和你将要围绕的轮廓对象，点击菜单—>对象—>文本绕排—>建立，一步到位。
## 快速取辅色——>混合打散
对于为主色搭配同色系颜色，用选择主色—>混合工具—>10步—>打散，能得到10个过渡色，如果不太擅长配色，这是一种很好的选择。
## 渐变&单色快捷填色——>结合shift键
对于渐变，按住shift+吸管能快速给渐变节点单填充颜色。对于单色，按住shift+吸管可以指定修改填充色或描边色。
## 找到最接近的专色——>色标簿
对于专色印刷，不必去翻Pantone色卡，选中你需要获取的颜色色块，对象—>颜色—>右上角下拉菜单—>创建新色板，之后切换到“颜色参考”面板，点击面板下方图标—>色标簿—> PANTONE，从面板上取得最接近目标的专色号。
## 表达式
AI 里大多数（应该是全部，不过我不敢打保票）文本框中，如果是输入数字的，那同样可以输入简单的表达式,+-*/
## 图层
右上角三条杠下拉菜单里有个粘贴时保持图层的选项，勾选后复制粘贴多个图层物体会对应分开；
## 精准移动
点击对象并双击选择工具，便可以像在Photoshop里一样精准地控制物体的水平宽度、迟滞高度、垂直高度、旋转角度以及距离。
## 新建文档
大家都知道ctr+N是新建文档，but很少人知道alt+ctrl+N是无对话框新建文档，新文档配置保持最近一次设置。
## 吸管工具
吸管工具，以前以为吸管工具能用来复制颜色，后来看别人作图用选择工具选字体，然后用吸管去吸取别的字体属性，然后字体字号就和被吸取的一样了。
## 文字渐变
文字在不转曲的前提下添加渐变效果。在“外观”面板上点击左下角的“添加新填色”，然后点选色板上的渐变。
## 就地粘贴
多画板复制粘贴,AI多画板复制粘贴的时候，我都是粘完再对齐，直到我知道了ctrl+f。。。。。就地粘贴ctrl+shift+v
## 分别变换
ctrl+alt+shift+d
...
![image-20230507225042485](adobe-illustrator.assets/image-20230507225042485.png)

## 显示所有使用的颜色

打开“文件”后，进行下面的操作；在`色板`面板下，单击`汉堡`菜单`添加使用的颜色`。

![image-20230507223714397](adobe-illustrator.assets/image-20230507223714397.png)

选择上相近的颜色，需要保留的必需是第一个选择上。颜色设置为全局颜色后。选择后点击`汉堡`菜单选择`合并色板`这样即可把相同的色板合并成一个颜色。
...
![image-20230423175922599](adobe-illustrator.assets/image-20230423175922599.png)
...
![image-20230422080916273](adobe-illustrator.assets/image-20230422080916273.png)

## 校正图形

1、先在要校在的图形上画一条直线；2、再画一条参考线与直线垂直。3、缘垂直的点旋转角度与参考线垂直；

![image-20230422072234030](adobe-illustrator.assets/image-20230422072234030.png)
...
![image-20230421205831261](adobe-illustrator.assets/image-20230421205831261.png)
...
![img](adobe-illustrator.assets/zgfta.jpg)

## 绳子制作

![绳子制作](adobe-illustrator.assets/sz.png)
...
![标题文本快速转段落文本](adobe-illustrator.assets/btzdl.gif)
...
![西文的正确竖排方式](adobe-illustrator.assets/xwsp.gif)
...
![文本快速拆分为可编辑单字](adobe-illustrator.assets/20220731-a.gif)
...
![变高数字](adobe-illustrator.assets/zfbgs.gif)

## 路径翻转

![路径翻转](adobe-illustrator.assets/ljfz.png)

按 `P`切换致钢笔工具，按住 `alt`点击段点即可转换

## 描边文字

![描边文字](adobe-illustrator.assets/stroke-text-a.png)

![描边文字](adobe-illustrator.assets/stroke-text-b.png)

![描边文字](adobe-illustrator.assets/stroke-text-c.png)
...
![百分比](adobe-illustrator.assets/illustrator-tips40.jpg)
...
![用形状生成工具画爱心](adobe-illustrator.assets/illustrator-tips68.jpg)
...
![快速调整星形形状](adobe-illustrator.assets/illustrator-tips35.jpg)
...
![快速切割对象1](adobe-illustrator.assets/illustrator-tips51.png)
...
![专色1](adobe-illustrator.assets/illustrator-tips30.jpg)
...
![专色3](adobe-illustrator.assets/illustrator-tips2.jpg)
...
![画板的模版功能](adobe-illustrator.assets/illustrator-tips44.jpg)
...
![多重描边](adobe-illustrator.assets/illustrator-tips32.png)
...
![选中重叠的对象](adobe-illustrator.assets/illustrator-tips65.gif)
...
![选中重叠的对象](adobe-illustrator.assets/illustrator-tips6.gif)
...
- A方法
  ![放射光线效果01](adobe-illustrator.assets/illustrator-tips64.png)

![放射光线效果02](adobe-illustrator.assets/illustrator-tips37.png)

![放射光线效果03](adobe-illustrator.assets/illustrator-tips25.png)

![放射光线效果04](adobe-illustrator.assets/illustrator-tips11.png)

- B方法
  ![AI 轻松画发散图案](adobe-illustrator.assets/ai_tips01.png)
...
![illustrator快捷键](adobe-illustrator.assets/illustrator-tips53.png)
...
![快速选择补色](adobe-illustrator.assets/illustrator-tips36.jpg)
...
![从网格形状中提取路径](adobe-illustrator.assets/illustrator-tips52.jpg)
...
！
![在打开的选项卡文档之间快速切换](adobe-illustrator.assets/illustrator-tips43.jpg)
...
![快速预览图形样式](adobe-illustrator.assets/illustrator-tips26.jpg)
...
![默认角半径](adobe-illustrator.assets/illustrator-tips42.jpg)
...
![默认角半径](adobe-illustrator.assets/illustrator-tips58.jpg)
...
![快速创建画板](adobe-illustrator.assets/illustrator-tips3.jpg)
...
![减法三原料的混合--CMYK](adobe-illustrator.assets/illustrator-tips5.png)
...
![640](adobe-illustrator.assets/640.jpg)

![641](adobe-illustrator.assets/641.jpg)

![642](adobe-illustrator.assets/642.jpg)

![643](adobe-illustrator.assets/643.jpg)

![644](adobe-illustrator.assets/644.jpg)

![645](adobe-illustrator.assets/645.jpg)

![646](adobe-illustrator.assets/646.jpg)

![647](adobe-illustrator.assets/647.jpg)

![648](adobe-illustrator.assets/648.jpg)
...
![刻刀](adobe-illustrator.assets/ai-tips1.png)

## 画笔工具选项

![画笔工具选项](adobe-illustrator.assets/ai-tips15.png)
...
![方头端点](adobe-illustrator.assets/ai-tips5.png)

## 直排内横排

![直排内横排](adobe-illustrator.assets/ai-tips9.png)

## 画黄金分割线

![画黄金分割线01](adobe-illustrator.assets/ai-tips7.png)

![画黄金分割线02](adobe-illustrator.assets/ai-tips8.png)

## 怎么把一个图片转换成黑白矢量图

![怎么把一个图片转换成黑白矢量图](adobe-illustrator.assets/ai-tips3.png)
...
![ai不透明度蒙版](adobe-illustrator.assets/adobe-illustrator-004.jpg)
...
![AI快速合并图形方法](adobe-illustrator.assets/adobe-illustrator-007.jpg)
...
![AI快速合并图形方法](adobe-illustrator.assets/adobe-illustrator-011.jpg)
...
2. 打开色板面板，直接将图案拖入也可。
   ![图案](adobe-illustrator.assets/adobe-illustrator-016.jpg)
...
![ai剪切组转换成路径图形方法](adobe-illustrator.assets/adobe-illustrator-022.jpg)
...
![路径查找器](adobe-illustrator.assets/illustrator-a.jpg)
...
![路径查找器](adobe-illustrator.assets/illustrator-c.jpg)

当然，这只不过是配色的一种方法而已，设计主题、品牌调性才是配色最需要考虑的因素，所以不要照搬配色工具。

## 巧用橡皮擦工具

![巧用橡皮擦工具](adobe-illustrator.assets/illustrator-a01.jpg)

## 利用拼合透明度裁切位图

![利用拼合透明度裁切位图](adobe-illustrator.assets/illustrator-a02.jpg)

![利用拼合透明度裁切位图](adobe-illustrator.assets/illustrator-a03.jpg)

## 互补色、对比色、邻近色、同类色

![互补色、对比色、邻近色、同类色](adobe-illustrator.assets/色彩.jpg)
